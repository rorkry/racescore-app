...
# アップロード
entry_file = st.file_uploader("🔼 出馬表CSV", type="csv")
level_file = st.file_uploader("🔼 レースレベルマスタCSV", type="csv")
...
if entry_file and level_file:
    ...
    st.info("2つのCSVファイルをアップロードしてください（出馬表 / レースレベルマスタ）")
